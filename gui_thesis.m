...
% Last Modified by GUIDE v2.5 25-Jun-2019 18:11:58
...
tx = get (handles.edit4,'string');
S = serial ('COM9','BaudRate',9600);
fopen(S);
fprintf(S,tx);
fwrite(S,13); % 13 stands for Enter
delete(S);
...
set (handles.edit2,'string',Moist);
set (handles.edit3,'string',Lux);
fclose(S);
